...
<img src="<?=$produtos[$d]["foto"] ?>" class="shadow-lg p-1 mb-5 bg-body rounded img-fluid rounded-circle mx-auto d-block" style="width: 500px" alt="<?= $doces_descricao[$d]["title"]; ?>">
<br><br>

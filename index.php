...
<head>
    ...
    <title>Doces A Gosto</title>
</head>
<body>
    <div class="container">
        <div class="row">
            <div class="col-10">
                <header class="bg-primary" style="--bs-bg-opacity: .1;"> 
                    <img src="./images/logo.png" alt="Logo marca" style="width: 100px; padding-bottom: 50px;" class="float-start">
                    <nav>
                    ...
                    <!-- Espaço para apresentação das paginas do site -->
                        ...
                        <?php
                            ...
                            switch ($valor) {
                                ...
                                case "doce4": $d=4; require_once './pages/doce.php'; break;
        ...
        <div class="row" style="padding-top: 100px;">
            <div class="col-12 bg-primary" style="--bs-bg-opacity: .1;">
                <footer>
                    <p class="text-center">Gabriel Cremer Cordeiro  <br> RA 20080841-5</p>
                </footer>
            </div>
        </div>
